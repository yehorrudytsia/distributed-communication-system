...
var Storage3 = /** @class */ (function () {
    function Storage3(db) {
        this.db = db;
    }
    Storage3.prototype.getUser = function (login) {
        var result = this.db
    ...
    Storage3.prototype.getUserId = function (token) {
        var result = this.db
